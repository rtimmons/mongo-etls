...
SELECT  CAST(vs."_id" AS VARCHAR)        AS "_id",
        ...
        vs."task_group"                  AS "task_group",
        vs."task_group_max_hosts"        AS "task_group_max_hosts",
        ...
        -- </COMMON_ETL_FIELDS>
FROM  "tpm_build_failures_atlas"."coredb-patchbuild-optimizer"."query_patch_version_task_data" AS vs
