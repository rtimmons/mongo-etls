...
SELECT CAST(
            row("project", "variant", "task_name", "test_name", "request_type", DATE("task_create_iso")) AS
            row("project" VARCHAR, "variant" VARCHAR, "task_name" VARCHAR, "test_name" VARCHAR, "request_type" VARCHAR, "date" DATE)
        )                                                              AS "info",
